...
pre_momentk2(:,1) = pknee(:,1)-cos2(:,1);
pre_momentk2(:,2) = pknee(:,2)-cos2(:,2);
pre_momentk2(:,3) = 0;
...
pre_momenth1(:,1) = pknee(:,1)-cos2(:,3);
pre_momenth1(:,2) = pknee(:,2)-cos2(:,4);
pre_momenth1(:,3) = 0;
...
pre_momenth2(:,1) = phip(:,1)-cos2(:,3);
pre_momenth2(:,2) = phip(:,2)-cos2(:,4);
pre_momenth2(:,3) = 0;
...
for n = 1:sz1(1)
	moment = cross([cos2(n,5)-phip(n,1) cos2(n,6)-phip(n,2) 0], [0 m_upper*g 0]);
